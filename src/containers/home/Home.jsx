        ...
        <>
            <Main>
                <div style={{ width:{ xs:"100%",  md:"50%"}}}>
                    ...
                    <br />
                    <ButtonGroup>
                        <Button variant='contained' color='error' endIcon={<ICONS.NavigateNextIcon />}> Order Now </Button>
                    </ButtonGroup> &nbsp;
                    <ButtonGroup>
                    ...
                    <Security>
                        <p> <ICONS.LocalShippingIcon sx={{ color: "red" }} /> NO Shipping Charge </p>
                        <p> <ICONS.VerifiedUserIcon sx={{ color: "red" }} /> 100% Secure CheckOut </p>
                    </Security>
                </div>
                <div>
                    <img src={LOGOS.hero} alt='logo' />
                </div>
            </Main>
            <SubContent>
                <div>
            ...
            <Location>
                <div>
                    <img src={LOGOS.location} alt='Location' />
                </div>
                <div style={{ width:{ xs:"100%",  md:"50%"}}}>
                    <h1> Why <span> Tasty Treat</span> ? </h1>
                    <p>As it gives:</p>
                    <h2> <ICONS.ForwardIcon /> Fresh and Tasty Foods </h2>
                    ...
                    <h2> <ICONS.ForwardIcon /> Quality Support </h2>
                    ...
                    <h2> <ICONS.ForwardIcon /> Order from any Location </h2>
